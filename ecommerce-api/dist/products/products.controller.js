...
const product_joi_1 = require("./schemas/product.joi");
...
__decorate([
    ...
    (0, common_1.UsePipes)(new joi_validation_pipe_1.JoiValidationPipe(product_joi_1.CreateProductSchema)),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.UsePipes)(new joi_validation_pipe_1.JoiValidationPipe(product_joi_1.UpdateProductSchema)),
    __param(0, (0, common_1.Param)('id')),
